...
public class Rangpur extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvError= (TextView) findViewById(R.id.tvRangpurError);
        tvDivision= (TextView) findViewById(R.id.tvRangpurDivisiond);
        tvDate= (TextView) findViewById(R.id.tvRangpurDate);
        tvDescription= (TextView) findViewById(R.id.tvRangpurDescriptionn);


        //tvIcon= (TextView) findViewById(R.id.LDhakaIcon);
        tvTemperature= (TextView) findViewById(R.id.tvRangpurTemperaturet);
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    if (icon.equals("01d")){
                        ...
                        LinearLayout ll= (LinearLayout) findViewById(R.id.LRangpurIcon);
