...
public class Mymensingh extends AppCompatActivity {
    private final static String urlDhaka = "http://api.openweathermap.org/data/2.5/weather?q=Mymensingh,bd&appid=2de143494c0b295cca9337e1e96b00e0";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvError= (TextView) findViewById(R.id.tvMymensinghError);
        tvDivision= (TextView) findViewById(R.id.tvMymensinghDivisiond);
        tvDate= (TextView) findViewById(R.id.tvMymensinghDate);
        tvDescription= (TextView) findViewById(R.id.tvMymensinghDescriptionn);


        //tvIcon= (TextView) findViewById(R.id.LDhakaIcon);
        tvTemperature= (TextView) findViewById(R.id.tvMymensinghTemperaturet);
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    if (icon.equals("01d")){
                        ...
                        LinearLayout ll= (LinearLayout) findViewById(R.id.LMymensinghIcon);
