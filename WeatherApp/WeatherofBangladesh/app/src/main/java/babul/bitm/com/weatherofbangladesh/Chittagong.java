...
public class Chittagong extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvError= (TextView) findViewById(R.id.tvChittagongError);
        tvDivision= (TextView) findViewById(R.id.tvChittagongDivisiond);
        tvDate= (TextView) findViewById(R.id.tvChittagongDate);
        tvDescription= (TextView) findViewById(R.id.tvChittagongDescriptionn);


        //tvIcon= (TextView) findViewById(R.id.LDhakaIcon);
        tvTemperature= (TextView) findViewById(R.id.tvChittagongTemperaturet);
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    if (icon.equals("01d")){
                        ...
                        LinearLayout ll= (LinearLayout) findViewById(R.id.LChittagongIcon);
