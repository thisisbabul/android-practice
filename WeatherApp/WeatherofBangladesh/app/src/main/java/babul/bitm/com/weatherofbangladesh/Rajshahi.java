...
public class Rajshahi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvError= (TextView) findViewById(R.id.tvRajshahiError);
        tvDivision= (TextView) findViewById(R.id.tvRajshahiDivisiond);
        tvDate= (TextView) findViewById(R.id.tvRajshahiDate);
        tvDescription= (TextView) findViewById(R.id.tvRajshahiDescriptionn);


        //tvIcon= (TextView) findViewById(R.id.LDhakaIcon);
        tvTemperature= (TextView) findViewById(R.id.tvRajshahiTemperaturet);
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    if (icon.equals("01d")){
                        ...
                        LinearLayout ll= (LinearLayout) findViewById(R.id.LRajshahiIcon);
