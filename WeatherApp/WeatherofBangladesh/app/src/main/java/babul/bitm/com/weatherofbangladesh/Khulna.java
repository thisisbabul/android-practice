...
public class Khulna extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvError= (TextView) findViewById(R.id.tvKhulnaError);
        tvDivision= (TextView) findViewById(R.id.tvKhulnaDivisiond);
        tvDate= (TextView) findViewById(R.id.tvKhulnaDate);
        tvDescription= (TextView) findViewById(R.id.tvKhulnaDescriptionn);


        //tvIcon= (TextView) findViewById(R.id.LDhakaIcon);
        tvTemperature= (TextView) findViewById(R.id.tvKhulnaTemperaturet);
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    if (icon.equals("01d")){
                        ...
                        LinearLayout ll= (LinearLayout) findViewById(R.id.LKhulnaIcon);
