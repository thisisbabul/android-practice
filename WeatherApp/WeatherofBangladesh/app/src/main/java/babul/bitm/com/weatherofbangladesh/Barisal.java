...
public class Barisal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvError= (TextView) findViewById(R.id.tvBarisalError);
        tvDivision= (TextView) findViewById(R.id.tvBarisalDivisiond);
        tvDate= (TextView) findViewById(R.id.tvBarisalDate);
        tvDescription= (TextView) findViewById(R.id.tvBarisalDescriptionn);


        //tvIcon= (TextView) findViewById(R.id.LDhakaIcon);
        tvTemperature= (TextView) findViewById(R.id.tvBarisalTemperaturet);
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    if (icon.equals("01d")){
                        ...
                        LinearLayout ll= (LinearLayout) findViewById(R.id.LBarisalIcon);
